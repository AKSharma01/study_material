...
class QuestionCatalog(db.Model):
	...
	category = db.relationship('QuestionCategory', secondary='question_catalog_category', backref='question_catalog')#db.backref('category', lazy='dynamic')
	...
	def selected_dict_object(self, selected_columns=[]):
		try:
